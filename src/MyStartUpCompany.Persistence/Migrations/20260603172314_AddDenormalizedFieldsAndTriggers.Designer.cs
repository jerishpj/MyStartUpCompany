...
namespace MyStartUpCompany.Persistence.Migrations
{
    ...
    [Migration("20260603172314_AddDenormalizedFieldsAndTriggers")]
    partial class AddDenormalizedFieldsAndTriggers
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyStartUpCompany.Persistence.Entities.Office", b =>
                {
                    ...
                    b.HasIndex("BuildingName", "OfficeType", "IsActive")
                        .HasDatabaseName("IX_Office_Building_Type_Active");

                    b.HasIndex("IsActive", "BuildingName", "Department")
                        .HasDatabaseName("IX_Office_Active_Building_Department");

                    b.HasIndex("IsActive", "LocationCity", "LocationCountry")
                        .HasDatabaseName("IX_Office_Active_Location_Geographic");

                    b.HasIndex("LocationCity", "Department", "IsActive")
                        .HasDatabaseName("IX_Office_Location_Department_Active");

                    b.HasIndex("LocationCountry", "LocationRegion", "LocationCity")
